 ...
 * @author crist
 */
public class WhichmannHill extends javax.swing.JFrame {

    DefaultListModel listStringW = new DefaultListModel();

    public WhichmannHill() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        listW.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(listW);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WhichmannHill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WhichmannHill().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList<String> listW;
