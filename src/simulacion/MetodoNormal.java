...
public class MetodoNormal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        listNumbersT = new javax.swing.JList<>();
        ...
        jLabel2.setText("Cantidad del array");
        ...
        listNumbersT.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(listNumbersT);

        jButton1.setText("Hacer operación");
        ...
        listNumbersG.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane2.setViewportView(listNumbersG);

        jLabel3.setText("T(n-1)");
